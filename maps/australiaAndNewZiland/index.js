...
var geoData = {
  ...
  newZealand: [Highcharts.maps['countries/nz/nz-all'], ''],
};
...
anychart.onDocumentReady(function() {
  ...
  // chart1 = drawChart(anychart.math.rect(0, 0, '100%', '100%'), Convertor.convert(geoData['newZealand'][0]), 'Highcharts geo data');
  // chart1 = drawChart(anychart.math.rect(0, 0, '100%', '100%'), Convertor.convert(geoData['newZealand'][0]), 'Highcharts geo data');
  ...
  // chart2 = drawChart(anychart.math.rect(0, 0, '100%', '100%'),  'anychart.maps.australia', 'Anychart geo data');
  chart2 = drawChart(anychart.math.rect(0, 0, '100%', '100%'),  anychart.maps.australia_and_new_zealand, anychart.maps.australia_and_new_zealand.title);
  // chart2 = drawChart(anychart.math.rect(0, 0, '100%', '100%'),  geoData['newZealand'][0], 'Anychart geo data');
